            ...
            while (response < 1 || response > 3) {
                ...
                if(response == 1){
                    try{
                        ...
                        frontOfficeModule = new FrontOfficeModule(frontOfficeModuleSessionBeanRemote, currentEmployee, visitorSessionBeanRemote, adminSessionBeanRemote, roomSessionBeanRemote);
                        menuMain();
